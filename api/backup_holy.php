...
/**
 * Производит бэкап текущей базы данных в файл. По-умолчанию конвертирует данные из кодировки win-1251 в utf-8
 * 
 * @param string $tables  <p>список таблиц. если не указан, сохраняются ВСЕ.</p>
