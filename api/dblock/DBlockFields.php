...
/**
 *  ласс дл€ работы со свойствами блоков.
 */
class DBlockFields extends DBaseClass {
    ...
    /**
     * ¬озвращает список свойств по выбранному блоку
     * 
     * @param string/int dblock  <p>выбранный блок</p>
     * @param string/array $filter=Array()  <p>[не об€зательное] фильтр свойств</p>
     * @param string $sort = "sort ASC"  <p>[не об€зательное] пор€док сортировки свойств</p>
     */
     ...
     * <br><b>sort</b> - int - пор€док сортировки
     * <br><b>required</b> - bool - об€зательное ли поле, по умолчанию false
     ...
     * ”дал€ет свойство
     * 
     * @param int/string $name <p>ID/код удал€емого свойства</p>
     */
