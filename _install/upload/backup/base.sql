...
CREATE TABLE `system_data_block` (  `id` int(11) NOT NULL AUTO_INCREMENT,  `name` text NOT NULL,  `bgroup` int(11) NOT NULL,  `caption` text NOT NULL,  `sort` int(11) NOT NULL,  `fav` tinyint(1) NOT NULL,  `hide_folders` tinyint(1) NOT NULL,  `hide_folders2` tinyint(1) NOT NULL,  `hide_code` tinyint(1) NOT NULL,  `childs` text NOT NULL,  `meta` int(11) NOT NULL,  `bind_cache` text NOT NULL,  PRIMARY KEY (`id`),  UNIQUE KEY `name` (`name`(255))) ENGINE=MyISAM AUTO_INCREMENT=43 DEFAULT CHARSET=utf8;
...
INSERT INTO users VALUES("1","administrator_sayta","Администратор сайта","200","0","0","admin","dima.am@mail.ru","1","21232f297a57a5a743894a0e4a801fc3","e824699672ce057dfeb6b06227392876","1");
