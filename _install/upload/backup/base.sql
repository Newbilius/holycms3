...
CREATE TABLE `system_data_block` (  `id` int(11) NOT NULL AUTO_INCREMENT,  `name` tinytext CHARACTER SET cp1251 NOT NULL,  `bgroup` int(11) NOT NULL,  `caption` text CHARACTER SET cp1251 NOT NULL,  `sort` int(11) NOT NULL,  `fav` tinyint(1) NOT NULL,  `hide_folders` tinyint(1) NOT NULL,  `hide_folders2` tinyint(1) NOT NULL,  `hide_code` tinyint(1) NOT NULL,  PRIMARY KEY (`id`),  UNIQUE KEY `name` (`name`(255))) ENGINE=MyISAM AUTO_INCREMENT=43 DEFAULT CHARSET=latin1;
...
CREATE TABLE `system_data_block_types` (  `id` int(11) NOT NULL AUTO_INCREMENT,  `name` tinytext NOT NULL,  `caption` tinytext NOT NULL,  `basetype` tinytext NOT NULL,  `sort` int(11) NOT NULL,  PRIMARY KEY (`id`)) ENGINE=MyISAM AUTO_INCREMENT=18 DEFAULT CHARSET=cp1251;
...
CREATE TABLE `system_user_groups` (  `id` int(11) NOT NULL AUTO_INCREMENT,  `name` text NOT NULL,  `caption` text NOT NULL,  `sort` int(11) NOT NULL,  `parent` int(11) NOT NULL,  `folder` int(11) NOT NULL,  `read` text NOT NULL,  `add` text NOT NULL,  `edit` text NOT NULL,  `delete` text NOT NULL,  PRIMARY KEY (`id`)) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=cp1251;
...
CREATE TABLE `users` (  `id` int(11) NOT NULL AUTO_INCREMENT,  `name` text NOT NULL,  `caption` text NOT NULL,  `sort` int(11) NOT NULL,  `parent` int(11) NOT NULL,  `folder` int(11) NOT NULL,  `login` text NOT NULL,  `email` text NOT NULL,  `block_control` smallint(6) NOT NULL,  `pass` text NOT NULL,  `uid` tinytext NOT NULL,  `group` text NOT NULL,  PRIMARY KEY (`id`)) ENGINE=MyISAM AUTO_INCREMENT=5 DEFAULT CHARSET=cp1251;
INSERT INTO users VALUES("1","administrator_sayta","Администратор сайта","200","0","0","admin","dima.am@mail.ru","1","21232f297a57a5a743894a0e4a801fc3","f09409e7d9e6c1f7804fe3ed3e410493","");
