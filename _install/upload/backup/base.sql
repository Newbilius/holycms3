...
CREATE TABLE `cms_options` (  `id` int(11) NOT NULL AUTO_INCREMENT,  `name` text CHARACTER SET utf8 NOT NULL,  `caption` text CHARACTER SET utf8 NOT NULL,  `sort` int(11) NOT NULL,  `parent` int(11) NOT NULL,  `folder` int(11) NOT NULL,  `opt_block` text NOT NULL,  `opt_sort` text NOT NULL,  `opt_by` text NOT NULL,  `opt_count` int(11) NOT NULL,  PRIMARY KEY (`id`)) ENGINE=MyISAM DEFAULT CHARSET=utf8;
...
CREATE TABLE `system_data_block` (  `id` int(11) NOT NULL AUTO_INCREMENT,  `name` tinytext CHARACTER SET utf8 NOT NULL,  `bgroup` int(11) NOT NULL,  `caption` text CHARACTER SET utf8 NOT NULL,  `sort` int(11) NOT NULL,  `fav` tinyint(1) NOT NULL,  `hide_folders` tinyint(1) NOT NULL,  `hide_folders2` tinyint(1) NOT NULL,  `hide_code` tinyint(1) NOT NULL,  PRIMARY KEY (`id`),  UNIQUE KEY `name` (`name`(255))) ENGINE=MyISAM AUTO_INCREMENT=43 DEFAULT CHARSET=utf8;
...
CREATE TABLE `system_data_block_fields` (  `id` int(11) NOT NULL AUTO_INCREMENT,  `data_block` int(11) NOT NULL,  `name` tinytext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,  `caption` tinytext NOT NULL,  `type` int(11) NOT NULL,  `sort` int(11) NOT NULL,  `required` tinyint(4) NOT NULL,  `multiple` tinyint(4) NOT NULL,  `dgroup` int(11) NOT NULL,  `owner_type` tinyint(4) NOT NULL,  `add_values` text NOT NULL,  `not_list` tinyint(4) NOT NULL,  `admin_only` tinyint(4) NOT NULL,  `meta` tinyint(4) NOT NULL,  `not_element` tinyint(1) NOT NULL,  PRIMARY KEY (`id`)) ENGINE=MyISAM AUTO_INCREMENT=166 DEFAULT CHARSET=utf8;
...
CREATE TABLE `system_data_block_types` (  `id` int(11) NOT NULL AUTO_INCREMENT,  `name` tinytext NOT NULL,  `caption` tinytext NOT NULL,  `basetype` tinytext NOT NULL,  `sort` int(11) NOT NULL,  PRIMARY KEY (`id`)) ENGINE=MyISAM AUTO_INCREMENT=18 DEFAULT CHARSET=utf8;
