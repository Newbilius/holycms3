...
/*
  ...
  parent		получать данные с какого начиная элемента
  table		с какой таблицы брать данные
  (если не установлена,  данные берутся с $_OPTIONS['page_module'])
  not_root	true - получать все элементы, подходящие, false - только из корня
 */
